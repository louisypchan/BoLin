$.add("bl/doh", ["ve/core/kernel"], function(kernel){
    ...
    kernel.extend(doh.Deferred.prototype, {
    ...
    kernel.extend(doh.Deferred.prototype, {
        ...
        addCallback: function(cb, cbfn){
            ...
            if(arguments.length > 2){
                enclosed = kernel.ride(null, enclosed, arguments, 2);
            }
...
//
    var
        createFixture= function(group, test, type){
            ...
            }else if(kernel.isString(tObj.runTest)){
    ...
    doh._registerTest = function(group, test, type){
        ...
        var tObj;
        if(kernel.isFunction(test) || kernel.isString(test) || "runTest" in test){
            return createFixture(group, test, type) ? groupObj : 0;
        }else if(kernel.isArray(test)){
            // a vector of tests...
            ...
            for(var testName in test){
                ...
                if(kernel.isFunction(theTest) || kernel.isString(theTest)){
...
//
    doh.t = doh.assertTrue = function(/*Object*/ condition, /*String?*/ hint){
        ...
        //if(kernel.isString(condition) && condition.length){
        //	return true;
        //}
        if(!eval(condition)){
    ...
    doh.is = doh.assertEqual = function(/*Object*/ expected, /*Object*/ actual, /*String?*/ hint, doNotThrow){
        ...
        if( (kernel.isArray(expected) && kernel.isArray(actual))&&
    ...
    doh.isNot = doh.assertNotEqual = function(/*Object*/ notExpected, /*Object*/ actual, /*String?*/ hint){
        ...
        if( (kernel.isArray(notExpected) && kernel.isArray(actual))&&
...
//
    ...
    doh._calcTrialIterations =	function(/*String*/ groupName, /*Object*/ fixture){
        ...
        var calibrate = function () {
            var testFunc = kernel.ride(fixture, fixture.runTest);
